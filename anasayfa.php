...
<div data-theme=\"a\" data-role=\"header\">
		 ...
		 <a data-role=\"button\" data-direction=\"reverse\" data-transition=\"slide\" href=\"#right-panel\" data-icon=\"flat-menu\" data-iconpos=\"right\" id=\"notekle\"class=\"ui-btn-right\">Profilim</a>
...
<!--/AÇILIR PANEL -->
            ...
            <li data-theme=\"a\" data-icon=\"flat-settings\" ><a href=\"profilduzenle2.php\" data-transition=\"slide\" style=\"text-decoration: none;\">Bilgileri Guncelle</a></li>
			<div class=\"hrl\"><hr /></div>
			<li data-theme=\"a\" data-icon=\"flat-eye\"><a href=\"tema/\" data-transition=\"slide\" style=\"text-decoration: none;\">Tema Seç</a></li>
			<div class=\"hrl\"><hr /></div>
            <li data-theme=\"a\" data-icon=\"flat-checkround\"><a href=\"eng\anasayfa.php\" data-transition=\"slide\" style=\"text-decoration: none;\">Change Language</a></li>
			<div class=\"hrl\"><hr /></div>
            <li data-theme=\"a\" data-icon=\"flat-bubble\"><a href=\"hakkinda.php\"  data-transition=\"flow\" style=\"text-decoration: none;\">Notdefter.in Nedir?</a></li>
			<div class=\"hrl\"><hr /></div>
			...
			Copyright © 2014 Tüm Hakları Saklıdır.</br>
...
<div data-role="panel" id="right-panel" data-theme="b" data-position="right" data-display="overlay">
	...
	<!-- Butonlar -->
    <a href="sifredegistir.php" data-rel="dialog"><div style="position:absolute; z-index:5; top:5px; left:5px; "><img src="settings.png" height="33" width="33"></center></div></a>
...
<div style="position:absolute; top:280px; font-size:13px; width:250px; color:#666; font-family: 'Doppio One', sans-serif;"><center><?php echo $mail; ?> <i class="icon-mail"></i></center></div>
    ...
    <div style="position:absolute; z-index:4; left:20px; top:313px; font-size:12px; color:#666; text-shadow: 0 0 1px #fff; font-family: 'Doppio One', sans-serif; width:250px; height:50px;">Girdiğin Not Sayısı<div style="position:absolute; z-index:4; width:100px; font-size:40px; color:#666; text-shadow: 0 0 5px #999; font-family: 'Doppio One', sans-serif; height:50px;"><center><?php echo $tek[0] ?></center></div></div>

    <div style="position:absolute; z-index:4;left:150px; font-size:12px; top:313px; color:#666; text-shadow: 0 0 1px #fff; font-family: 'Doppio One', sans-serif; width:250px; height:50px;">Notdefter.in Puanın<div style="position:absolute; z-index:4; font-size:40px; left:20px; color:#666; text-shadow: 0 0 5px #999; font-family: 'Doppio One', sans-serif; height:50px;"><center>951</center></div></div>
...
<!--/SAĞ AÇILIR PANEL -->			
            ...
            <ol id="joyRideTipContent">
              <li data-text="Evet">
                ...
                <p>Artık notlarını online bir ortamda güvenli bir şekilde saklayabilirsin. Sana kısaca uygulamayı tanıtmamı ister misin?</p>
              </li>
              <li data-id="notekle" data-button="İleri" data-options="tipLocation:right;">
                <h4>Profilinizi Görüntüleyin</h4>
                <p>Profilim butonuna tıklayarak şifrenizi, profil bilgilerinizi ve profil fotoğrafınızı değiştirebilir, toplam kaç not girdiğinizi ve Notdefter.in puanınızı görebilirsiniz.</p>
              </li>
              ...
              <li data-text="Turu Bitir">
                <h4>Teşekkürler</h4>
                <p>Notdefter.in'i kullandığın için teşekkürler.</p>
              </li>
            </ol>
</div>
