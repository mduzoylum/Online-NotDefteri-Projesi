...
<div data-role=\"page\" id=\"page1\">
    ...
    <div data-role=\"content\">
        <form action=\"notekle.php\" method=\"post\" data-ajax=\"false\">
            <div data-role=\"fieldcontain\"><center>
               Sistemimiz Notlarinizi internet ortaminda saklayabilmeniz icin tasarlanmistir.<br>
        Bu sistemden notlariniza herhangi internete bagli bir cihazdan guvenle ulasabilirsiniz.<br>
        Kisisel hayat ozgurlugu acisindan notlariniz 2.sahislar tarafindan erisime kapalidir.</center>
            </div>
...
echo "<div style=\"position:absolute; font-size:16px; font-weight:bold; text-shadow: 0 0 8px #000000; font-family: 'Varela', sans-serif; color:#fff; margin-top:12px; z-index:9999;\"><center>Notunuzu Birakin</center><div>";
echo "
<div style=\"margin-top:50px; margin-left:15px; margin-right:15px;\">
<form name=\"form1\" method=\"post\" action=\"notekle.php?Git=$id\">
	<input type=\"text\" name=\"baslik\" placeholder=\"Not Basligi\" id=\"baslik\">
	<textarea name=\"icerik\" style=\"height:200px;\"; rows=\"4\" placeholder=\"Not Içerigi (Max 3000 karakter)\" id=\"icerik\" cols=\"45\" rows=\"5\"></textarea>
...
$icerik=$_POST["icerik"];
	if($baslik=="")
	{
	echo "<script>alert(\"Baslik Bos Birakilamaz\")</script>";
	}
	elseif($icerik=="")
	{
	echo "<script>alert(\"Içerik Bos Birakilamaz\")</script>";
	}
	else
	{	
		...
		/*if($ekle)
		{
		echo "<script>alert(\"Ekleme Basarili\")</script>";*/
	//GOTO("anasayfa.php");?>
    ...
    <?php
		...
		{
		echo "<script>alert(\"Basarisiz!!!\")</script>";
		}
*/
	}
