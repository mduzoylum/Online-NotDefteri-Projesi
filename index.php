...
<div data-role="page" id="page1">
    <div data-theme="a" data-role="header">
         ...
         <div style="margin-top:-2px; padding:-3px; position:absolute; z-index:999; margin-left:130px;margin-top: -8px;"><a href="giris?language=tr"><img src="tr.png" height="36" width="36" style="margin-right: 5px;"></a><a href="giris?language=eng"><img src="eng.png" height="36" width="36" ></a></div>
...
<div data-role="content">
			<form action="aktariliyor" method="post" >
        ...
        <div id="checkboxes1" data-role="fieldcontain">
         ...
         <input name="submit" type="submit" value="Giriş Yap" id="submit_btn" data-theme="a" />
            ...
            <center>
	<div data-role="content" >
        <a data-role="button" target="_self" data-theme="a"  data-transition="flow" href="hatirlat" >Şifremi Unuttum</a>
        <a data-role="button" target="_self" data-theme="d"  data-transition="slide" href="uyeol" >Üye Ol</a>
    </div>
    <div>
...
<div data-role="content">
	...
	<div data-role="content" >
        ...
        <a data-role="button" target="_self" data-theme="d"  data-transition="slide" href="uyeol.php" >Sign Up</a>
    </div>
    <div>
    <a href="../NotDefter.in.apk" class="link" target="_blank" ><img src="ic_launcher.png" width="64" height="64" /></a>
    </div>
