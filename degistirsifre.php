...
if(mysql_num_rows($kontrol)==0){
	$degiskenimiz ="Hatalı bir adrese geldiniz";
	?>
...
<div data-role="page" id="page1">
    ...
    <div data-role="content">
        <h4>
            E-postanıza gelen şifre sıfırlama linkleri tek kullanımlıktır. 
        </h4>
        <h5>
            <?php 
				...
				<table align=\"center\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"600\" style=\"border: 1px solid #cccccc; border-collapse: collapse;\">
					...
					<tr>
					  <td bgcolor=\"#ffffff\" style=\"padding: 40px 30px 40px 30px;\"><table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">
					    <tr>
					      <td style=\"color: #153643; fhttp://www.notdefter.inont-family: Arial, sans-serif; font-size: 24px;\"><h6>Tekrar Merhaba, $adisi </h6></td>
				        </tr>
					    <tr>
					      <td height=\"77\" style=\"padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;\">&quot;$kadisi&quot; kullanıcı adlı Notdefter.in hesabınızın şifresi aşağıdadır. Dilerseniz şifrenizi, sisteme yeni şifreniz ile giriş yaptıktan sonra şifre değiştir menüsü altından değiştirebilirsiniz.</td>
				        </tr>
				      </table></td>
				  </tr>
					<tr>
					  <td bgcolor=\"#ffffff\" style=\"padding: 40px 30px 40px 30px;\"><table width=\"100%\" border=\"0\">
					    <tr>
					      <td>&nbsp;</td>
					      <td align=\"center\" style=\"color: #ffffff; font-family: Verdana, Geneva, sans-serif; font-size: 14px;\" height=\"34\" width=\"252\" background=\"http://www.notdefter.in/mail/images/link3.jpg\">Yeni Şifreniz: <b>$yeniparola</b></td>
					      <td>&nbsp;</td>
				        </tr>
					    </table></td>
					</tr>
...
<div data-role=\"page\" id=\"page1\">
    ...
    <div data-role=\"content\">
        <h4>
            E-posta adresine yeni şifreni gönderdik.
        </h4>
        <h5>
            Yeni belirlediğimiz şifre ile sisteme giriş yaptıktan sonra şifremi değiştir menüsünden şifreni değiştirebilirsin.
        </h5>
        <a data-role=\"button\" data-inline=\"true\" data-transition=\"flow\" data-theme=\"a\"
        href=\"giris.php\">
            Giriş Yap
