...
<div id="content">
  ...
  <input type="hidden" name="username" id="username" value="<?php $vkadi ?>" class="required" minlength="5" class="form_element"/>
   	 ...
   	 <div style="margin-left:0px; margin-top:17px; position:absolute;">Password: </div><div style="margin-left:110px;" class="style_form">
      <input type="password" name="sifre1" id="sifre1" value="" class="form_element"/>
	  <span id="availability_statusm"></span>
    </div>
    <div style="margin-left:0px; margin-top:17px; position:absolute;">Password Again: </div><div style="margin-left:110px;" class="style_form">
