...
<div data-role="page" id="page1">
    ...
    <div style="margin-left:15px; margin-right:15px;"><center><h5>if you forgot your password,please you make instruction.</h5></center></div>
<div style="margin-top:50px; margin-left:20px; margin-right:20px;">
<form action="sifreiste" method="post">
    <input name="eposta" placeholder="Your Mail Adress" type="text" /><br/><br/>
 <div>
     <input type="submit" data-theme="d" value="Forgot Password!" />
 </div>
</form>
</div>
