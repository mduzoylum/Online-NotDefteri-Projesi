    ...
    <div data-role=\"content\">
        <form action=\"notekle.php\" method=\"post\" data-ajax=\"false\">
            <div data-role=\"fieldcontain\"><center>
               We keep a note in our system is designed for the internet environment.<br>
        From this system to your notes from any device connected to the Internet can be reached with confidence.<br>
        Personal life is in terms of freedom of notes other parties to access is closed.</center>
            </div>
...
$icerik=$_POST["icerik"];
	if($baslik=="")
	{
	echo "<script>alert(\"Başlık Boş Bırakılamaz\")</script>";
	}
	elseif($icerik=="")
	{
	echo "<script>alert(\"İçerik Boş Bırakılamaz\")</script>";
	}
	else
	{	
