...
echo "<div data-role=\"page\" id=\"page1\">
    ...
    <div data-role=\"content\">
        <div class=\"ui-grid-a\">
            ...
            <a data-role=\"button\" a href=\"tok.php?ok=$tema_uye\" name=\"submit\" type=\"submit\" data-icon=\"check\" data-iconpos=\"left\">Apply theme
       </a>
    </div>
    <div data-theme=\"b\" data-role=\"footer\" data-position=\"fixed\" data-tap-toggle=\"true\">
        <h1>
            <div style=\"font-size:10px;\">The theme you choose to save click to apply the theme.</div>
        </h1>
    </div>
</div>";
