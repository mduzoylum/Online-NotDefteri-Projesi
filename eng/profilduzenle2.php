...
<div id="content">
  <form action="profilduzenle2.php" method="post">
    ...
    <div style="margin-left:0px; margin-top:8px; position:absolute;">Username: </div><div style="margin-left:110px;" class="style_form">
     <?php echo $vkadi?>
    ...
    <div style="margin-left:0px; margin-top:17px; position:absolute;">Name Surname: </div> <div style="margin-left:110px;" class="style_form">
      <input type="text" name="adi" id="adi" value="<?php echo $adi?>" class="required" minlength="5" class="form_element"/>
    </div>
    
    <div style="margin-left:0px; margin-top:17px; position:absolute;">Gender: </div> <div style="margin-left:110px;" class="style_form">
    ...
    <div style="margin-left:0px; margin-top:17px; position:absolute;">Birth Date: </div><div style="margin-left:110px;" class="style_form">
   <input name="mydate" id="mydate" type="date"  data-role="datebox" data-options='{"mode": "slidebox"}'>
   </div>
    
	 <div style="margin-left:0px; margin-top:17px; position:absolute;">GSM Number: </div><div style="margin-left:110px;" class="style_form">
	 ...
	 <div style="margin-left:0px; margin-top:17px; position:absolute;">E-mail Address: </div><div style="margin-left:110px;" class="style_form">
	...
	<div class="style_form"></br>
      <input name="submit" type="submit" value="Update" data-theme="a"  id="submit_btn" />
    </div>
  </form>
</div>
...
//	$kadii=@$_POST["username"];
	...
	$epostai=@$_POST["mail"];
			...
			if($adii=="")
			{
				echo "<script>alert(\"Your name is empty !\")</script>";
			...
			{
			echo "<script>alert(\"This mail address wrong!!\")</script>";
			} 
            else {
